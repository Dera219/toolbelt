...
class OAuthIdentity(Base):
    """A provider account linked to a ToolBelt user.

    The provider's subject claim is the stable key — emails change, and Apple
    stops sending one after the first sign-in.
    """
